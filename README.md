...
## Overview
This is a webpage that allows the user to enter various choices separated by a comma and then it randomly selects a choice. I guess this is a good way to make trivial decisions.
